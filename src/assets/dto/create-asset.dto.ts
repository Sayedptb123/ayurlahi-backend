import { IsString, IsNotEmpty, IsOptional, IsNumber, IsUUID, IsDateString, IsEnum, Min } from 'class-validator';
import { ApiProperty } from '@nestjs/swagger';
import { AssetStatus } from '../entities/asset.entity';

export class CreateAssetDto {
  @ApiProperty({ description: 'ID of the asset category' })
  @IsUUID()
  @IsNotEmpty()
  categoryId: string;
  ...
  @ApiProperty({ description: 'Unique code for tracking the asset (e.g. EQ-001)' })
  @IsString()
  @IsNotEmpty()
  assetCode: string;

  @ApiProperty({ description: 'Name/Title of the asset' })
  @IsString()
  @IsNotEmpty()
  name: string;
  ...
  @ApiProperty({ description: 'Current status of the asset', enum: AssetStatus, required: false, default: AssetStatus.ACTIVE })
  @IsEnum(AssetStatus)
  @IsOptional()
  status?: AssetStatus;
